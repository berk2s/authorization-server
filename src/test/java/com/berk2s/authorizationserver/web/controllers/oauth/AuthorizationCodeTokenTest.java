...
public class AuthorizationCodeTokenTest extends IntegrationTest {
    ...
    void testAuthorizationCodeTokenRequestWithMissingGrantType() throws Exception {
        ...
        encodedAuthorization = AuthenticationParser.encodeBase64("clientWithoutCode", "clientSecret");
    ...
    @DisplayName("Invalid Client Secret")
    @Test
    void invalidClientSecret() throws Exception {
        ...
        encodedAuthorization = AuthenticationParser.encodeBase64("clientWithSecret", "invalidClientSecret");

        params.remove("client_secret");
        params.add("client_secret", "invalidClientSecret");
